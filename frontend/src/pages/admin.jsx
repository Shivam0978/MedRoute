  ...
  return (
    <form onSubmit={async (e) => {
      ...
      <div className="grid sm:grid-cols-2 gap-2">
        ...
        <Input label="Latitude" value={String(v.lat)} onChange={(x) => setV((s) => ({ ...s, lat: x }))} />
        <Input label="Longitude" value={String(v.lng)} onChange={(x) => setV((s) => ({ ...s, lng: x }))} />
        <Input label="Rating (0–5)" value={String(v.rating)} onChange={(x) => setV((s) => ({ ...s, rating: x }))} />
  ...
  return (
    <form onSubmit={async (e) => {e.preventDefault();setBusy(true);try {
      ...
      <div className="grid sm:grid-cols-2 gap-2">
        ...
        <Input label="Consultation fee (₹)" value={String(v.consultation_fee)} onChange={(x) => setV((s) => ({ ...s, consultation_fee: x }))} />
        <Input label="Rating" value={String(v.rating)} onChange={(x) => setV((s) => ({ ...s, rating: x }))} />
